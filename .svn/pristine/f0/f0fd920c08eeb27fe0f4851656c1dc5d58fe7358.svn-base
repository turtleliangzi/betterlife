...
<div id="bl-mypage-content">
  ...
  <div class="bl-mypage-middle">
    <div class="bl-mypage-title">
      <h4>我的计划&nbsp;&nbsp; <small style="color:#669966">将要进行...</small></h4>
    ...
    <div class="bl-mypage-myplan">
      ...
      <div class="bl-label">
        <span class="bl-label-title">即将开始时间</span>
      ...
      <div class="bl-buttons">
        <a href="/plan/editplan?planid=<?php echo ($plan['planid']); ?>" type="button" class="btn btn-info"><i class="fa fa-cog"></i>修改计划</a>
        <button type="button" class="btn btn-success" id="advance"><i class="fa fa-hourglass-start"></i>提前开始</button>
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="form-group">
            <textarea class="form-control input-field" name="reason" placeholder="为什么放弃呢？可以保持沉默~"></textarea>          </div>
        </div>
      </div>
