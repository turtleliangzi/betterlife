...
<div id="bl-mypage-content">
  ...
  <div class="bl-mypage-middle">
    ...
    <?php if(empty($bsummaryList)): ?><div style="width:100%;text-align:center">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        <?php if(is_array($bsummaryList)): foreach($bsummaryList as $k=>$bsummary): ?><tr>
          <td><?php echo ($k+1); ?></td>
          <td><a href="/article/myarticle?articleid=<?php echo ($bsummary['conclusionid']); ?>&type=<?php echo ($bsummary['type']); ?>"><?php echo ($bsummary['title']); ?></a></td>
          <td><?php echo (date("Y-m-d H:m:s", $bsummary['createtime'] )); ?></td>
          <td>否</td>
          <td><a href="/article/addbriefsummary?articleid=<?php echo ($bsummary['conclusionid']); ?>&type=<?php echo ($bsummary['type']); ?>">编辑</a></td>
